				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am {{$user->name}}</h1>
							<h5 class="text-uppercase">junior laravel developer</h5>
			...
			<div class="filters-content">
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p1.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p1.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
					...
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p2.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p2.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p3.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p3.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p4.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p4.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p6.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p5.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p5.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p6.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all upcoming following">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p7.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p7.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p8.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p8.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
					...
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							<div class="single_portfolio">
								<img class="{{asset('/')}}assets/img-fluid w-100" src="{{asset('/')}}assets/img/portfolio/p9.jpg" alt="">
								<div class="overlay"></div>
								<a href="{{asset('/')}}assets/img/portfolio/p9.jpg" class="{{asset('/')}}assets/img-gal">
									<div class="icon">
										<span class="lnr lnr-cross"></span>
									</div>
								</a>
